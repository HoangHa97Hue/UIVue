        ...
        <form method="post" @submit="checkForm">
            ...
            <p class="typo__p" v-if="submitStatus === 'PENDING'">Sending...</p>
                ...
                <button  class="btn btn-secondary">
                            <router-link style="text-decoration: none;" to="/Create_Student">Sign UP
                            </router-link>
                        </button>
...
export default {
    ...
    created() {
        this.isFromRegisterPage = localStorage.getItem('fromRegisterPage');
    },
    methods: {
        signUp() {
        ...
        checkForm(e) {
            ...
            axios(options)
                .then(response => {
                    ...
                    if(this.isFromRegisterPage === 'true')//thi cho no qua thang dang ky StudentID
                    {
                        this.$emit("changeDisplayRegisTerOnCreate", false);
                        this.$router.push({ name: 'Create_Student' }).catch(() => { });
                    }else{
