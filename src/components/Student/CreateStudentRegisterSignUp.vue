    ...
    <div>
        ...
        <div class="container">
            ...
            <form method="post" @submit="checkForm">
                ...
                <button class="btn btn-primaryback btn" type="submit" :disabled="submitStatus === 'PENDING'">
...
export default {
    ...
    async mounted() {
        await axios
            ...
            .then(response => (this.listGrade = JSON.parse(JSON.stringify(response.data))));

        // fetch("https://localhost:44319/api/Grade", this.getTokenConfig())
        //     .then((response) => response.json())
        //     .then((data) => (this.listGrade = data));
        // await axios.get("https://localhost:44319/api/Grade", this.getTokenConfig())
        // .then(
        //   (response) =>
        //     (this.listGrade = JSON.parse(JSON.stringify(response.data)))
        // );
    ...
    methods: {
        ...
        checkForm(e) {
            ...
            this.form.AspUserID = this.userID;
